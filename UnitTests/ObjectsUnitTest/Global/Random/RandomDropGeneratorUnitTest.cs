...
namespace ObjectsUnitTest.Global.Random
{
    ...
    public class RandomDropGeneratorUnitTest
    {
        ...
        public void RandomDropGenerator_GenerateRandomWeapon_Club()
        {
            ...
            Assert.AreEqual("The club looks to well balanced with a frayed leather grip.", weapon.LongDescription);
        ...
        public void RandomDropGenerator_GenerateRandomWeapon_Mace()
        {
            ...
            Assert.AreEqual("The shaft of the mace is smooth and the head of the polished.", weapon.LongDescription);
        ...
        public void RandomDropGenerator_GenerateRandomWeapon_WizardStaff()
        {
            ...
            Assert.AreEqual("The wooden staff has gnarled fingers for a head.", weapon.LongDescription);
        ...
        public void RandomDropGenerator_GenerateRandomWeapon_Axe()
        {
            ...
            Assert.AreEqual("The axe could have been used by a great warrior of days or the local peasant down the road.  It is hard tell the history just from its looks.", weapon.LongDescription);
