...
{
    [TestClass]
    public class ClothUnitTest
    {
        private Cloth material;
        [TestInitialize]
        public void Setup()
        {
        ...
        [TestMethod]
        public void Cloth_Constructor()
        {
            Assert.AreEqual(0.1M, material.Bludgeon);
            Assert.AreEqual(0.1M, material.Pierce);
            Assert.AreEqual(0.1M, material.Slash);
            ...
            Assert.AreEqual(0.3M, material.Cold);
            Assert.AreEqual(0.1M, material.Fire);
            Assert.AreEqual(0.2M, material.Lightning);
            Assert.AreEqual(0.1M, material.Poison);
        }
    }
}