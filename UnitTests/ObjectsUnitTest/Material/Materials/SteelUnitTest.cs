...
{
    [TestClass]
    public class SteelUnitTest
    {
        private Steel material;
        [TestInitialize]
        public void Setup()
        {
        ...
        [TestMethod]
        public void Steel_Constructor()
        {
            Assert.AreEqual(0.3M, material.Bludgeon);
            Assert.AreEqual(0.3M, material.Pierce);
            Assert.AreEqual(0.3M, material.Slash);
