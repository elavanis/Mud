...
namespace ObjectsUnitTest.Skill.Skills.Damage
{
    ...
    public class PierceUnitTest
    {
        ...
        {
            Assert.IsFalse(pierce.Testable_MeetRequirments(mob.Object, mob.Object));
        }
        ...
        public void Pierce_MeetRequirments_Pass()
        {
            ...
            Assert.IsTrue(pierce.Testable_MeetRequirments(mob.Object, mob.Object));
        }
