...
{
    [TestClass]
    public class DamageDealtBeforeDefenseEnchantmentUnitTest
    {
        DamageDealtBeforeDefenseEnchantment enchantment;
        Mock<IEffect> effect;
        ...
        [TestMethod]
        public void DamageDealtBeforeDefenseEnchantment_DamageDealtAfterDefense_TargetIsDefender()
        {
            random.Setup(e => e.PercentDiceRoll(100)).Returns(true);

            enchantment.DamageDealtBeforeDefense(attacker.Object, defender.Object, 10);
        ...
        [TestMethod]
        public void DamageDealtBeforeDefenseEnchantment_DamageDealtAfterDefense_TargetIsAttacker()
        {
