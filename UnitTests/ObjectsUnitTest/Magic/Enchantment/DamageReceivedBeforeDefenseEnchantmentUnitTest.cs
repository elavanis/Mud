...
{
    [TestClass]
    public class DamageReceivedBeforeDefenseEnchantmentUnitTest
    {
        DamageReceivedBeforeDefenseEnchantment enchantment;
        Mock<IEffect> effect;
        ...
        [TestMethod]
        public void DamageReceivedBeforeDefenseEnchantment_DamageDealtAfterDefense_TargetIsDefender()
        {
            random.Setup(e => e.PercentDiceRoll(100)).Returns(true);

            enchantment.DamageReceivedBeforeDefense(attacker.Object, defender.Object, 10);
        ...
        [TestMethod]
        public void DamageReceivedBeforeDefenseEnchantment_DamageDealtAfterDefense_TargetIsAttacker()
        {
