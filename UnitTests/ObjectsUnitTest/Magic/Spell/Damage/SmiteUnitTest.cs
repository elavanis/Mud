...
namespace ObjectsUnitTest.Magic.Spell.Damage
{
    ...
    public class SmiteUnitTest
    {
        ...
        public void Smite()
        {
            ...
            Assert.AreEqual("{performer} looks at you with anger in his eyes.  Suddenly you are knocked back by a great force.", smite.PerformerNotificationSuccess.Message);
