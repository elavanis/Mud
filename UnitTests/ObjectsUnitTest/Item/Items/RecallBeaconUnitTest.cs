...
namespace ObjectsUnitTest.Item.Items
{
    ...
    public class RecallBeaconUnitTest
    {
        ...
        public void RecallBeacon_Constructor()
        {
            ...
            Assert.AreEqual("The recall beacon's soft blue color of a noon day sky is contrasted by the extreme hardness of the recall beacon itself.", beacon.LongDescription);
