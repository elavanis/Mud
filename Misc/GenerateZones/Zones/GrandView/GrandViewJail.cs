...
namespace GenerateZones.Zones
{
    public class GrandViewJail : BaseZone, IZoneCode
    {
        ...
        private IRoom GenerateRoom1()
        {
            ...
            room.LongDescription = "You are in what appears to be an old jail cell.  Light flickers from beyond the bars causing your shadow to dance on the walls.";
        ...
        private IRoom GenerateRoom2()
        {
            ...
            room.LongDescription = "This area is a low tunnel connecting the cell to an underground cavern.";
        ...
        private IRoom GenerateRoom3()
        {
            ...
            room.LongDescription = "The cavern opens up to a large area here.  Several colorful glowing mushrooms are growing here making it easy to see.  Maybe you should pick some up.";
        ...
        private IRoom GenerateRoom4()
        {
            ...
            room.LongDescription = "The tunnel here is steep and bendy.  The walls seem to close in on you as you make your way through.";
        ...
        private IRoom GenerateRoom5()
        {
            ...
            room.LongDescription = "The tunnel makes an abrupt direction change here.  To the east is are cliff and the sound of water.  Up is a ladder and to the west a tunnel of darkness.";
            room.ShortDescription = "A tunnel";
        ...
        private IRoom GenerateRoom6()
        {
            ...
            room.LongDescription = "You are on a ladder.  Above you is darkness, below you is darkness.";
        ...
        private IRoom GenerateRoom8()
        {
            ...
            room.LongDescription = "You can see light above you and darkness below.  Be careful not to fall.";
            room.ShortDescription = "A ladder";
        ...
        private IRoom GenerateRoom9()
        {
            ...
            room.LongDescription = "A huge ancient oak tree hides a hole in the ground from the street.";
        ...
        private IRoom GenerateRoom10()
        {
            ...
            room.LongDescription = "You stand in a grassy field half way between the street and a huge ancient oak tree.";
        ...
        private IRoom GenerateRoom11()
        {
            ...
            room.LongDescription = "The road runs east and west here and a field extends to the south with a huge oak tree dominating a small hill.";
        ...
        private IRoom GenerateRoom12()
        {
            ...
            room.LongDescription = "An arched sign extends over the street here and reads \"Grandview Meadows.\"";
        ...
        private IItem LionStatue()
        {
            ...
            statue.LongDescription = "The steps are flanked on each side by a pair of black marble lions which seem to almost come to life.";
        ...
        private IRoom GenerateRoom13()
        {
            ...
            room.LongDescription = "A paved court yard surrounds the giant dome to the north.";
        ...
        private IRoom GenerateRoom14()
        {
            ...
            room.ExamineDescription = "White paving stone extend outward from the center of the dome in a circular pattern.";
            room.LongDescription = "A paved court yard surrounds the giant dome to the north west.";
        ...
        private IRoom GenerateRoom15()
        {
            ...
            room.ExamineDescription = "White paving stone extend outward from the center of the dome in a circular pattern.";
            room.LongDescription = "A paved court yard surrounds the giant dome to the west.";
        ...
        private IRoom GenerateRoom16()
        {
            ...
            room.ExamineDescription = "White paving stone extend outward from the center of the dome in a circular pattern.";
            room.LongDescription = "A paved court yard surrounds the giant dome to the south west.";
        ...
        private IRoom GenerateRoom18()
        {
            ...
            room.ExamineDescription = "White paving stone extend outward from the center of the dome in a circular pattern.";
            room.LongDescription = "A paved court yard surrounds the giant dome to the south east.";
        ...
        private IRoom GenerateRoom19()
        {
            ...
            room.ExamineDescription = "White paving stone extend outward from the center of the dome in a circular pattern.";
            room.LongDescription = "A paved court yard surrounds the giant dome to the east.";
        ...
        private IRoom GenerateRoom20()
        {
            ...
            room.ExamineDescription = "White paving stone extend outward from the center of the dome in a circular pattern.";
            room.LongDescription = "A paved court yard surrounds the giant dome to the north east.";
...
East: The Training Hall";
        ...
        private IRoom GenerateRoom22()
        {
            ...
            room.LongDescription = "Two sprawling estates line the road here.";
        ...
        private IRoom GenerateRoom23()
        {
            ...
            room.LongDescription = "The two largest estates in the city are to the east and the west of here.";
        ...
        private IRoom GenerateRoom25()
        {
            ...
            room.LongDescription = "The city's library containing the public records, works of fiction and great books of magic stands to the north.  To the south lies Rockdale Avenue.";
        ...
        private IRoom GenerateRoom26()
        {
            ...
            room.LongDescription = "The cobble stones here are quite worn indicating this road it quite popular.";
        ...
        private IRoom GenerateRoom27()
        {
            ...
            room.LongDescription = "The road continues east and west for a long ways.  The shops and houses have given way to a small park.";
            room.ShortDescription = "A wide road";
        ...
        private IRoom GenerateRoom28()
        {
            ...
            room.LongDescription = "Lily pads float on the surface of the pond to the north creating a checker board effect.";
        ...
        private IRoom GenerateRoom29()
        {
            ...
            room.LongDescription = "A small stream of water creating a soothing sound as it babbles over rocks to feed the pond.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom30()
        {
            ...
            room.LongDescription = "The pond lies to the east and cat tails have grown up here obscuring view of some of the pond.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom31()
        {
            ...
            room.LongDescription = "The duck pond extends to the north underneath a wooden bridge to the east.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom32()
        {
            ...
            room.LongDescription = "Looking over the railing of the bridge you can see fish in the pond a few feet below.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom33()
        {
            ...
            room.LongDescription = "The duck pond extends to the north underneath a wooden bridge to the west.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom34()
        {
            ...
            room.LongDescription = "This side of the duck pond has a nice stone wall edging that makes it look more like it's part of a town park.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom35()
        {
            ...
            room.LongDescription = "The duck pond, another small jewel of the city lies to the north east.";
            room.ShortDescription = "Duck Pond";
        ...
        private IRoom GenerateRoom36()
        {
            ...
            room.LongDescription = "You are standing in the center of the duck pond.  Small fish swim around you curious as to who or what has entered their pond.";
            room.ShortDescription = "Duck Pond";
        ...
        private IItem Sign()
        {
            ...
            item.LongDescription = "The sign says \"IF YOU CAN READ THIS GET OUT OF THE DUCK POND\"";
        ...
        private INonPlayerCharacter DaddyDuck()
        {
            ...
            npc.LongDescription = "The daddy duck ignores you as he continues on his way.";
        ...
        private INonPlayerCharacter MommaDuck()
        {
            ...
            npc.LongDescription = "The momma duck looks cautiously at you be leaves you alone for the time being.";
        ...
        private INonPlayerCharacter BabyDuck()
        {
            ...
            npc.LongDescription = "The baby duck ignores you continues on its way.";
